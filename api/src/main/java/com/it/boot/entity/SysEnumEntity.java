...
public class SysEnumEntity extends BaseEntity implements TreeNode<Long> {
    // 省市县, 下拉菜单, 下拉级联菜单
    @Schema(title = "分组code", example = "test_1")
