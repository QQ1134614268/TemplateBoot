...
public class BaseEntity implements Serializable {
    ...
    @Schema(name = "创建时间", example = "2022-02-02 10:10:10", required = false, hidden = true)
    ...
    @Schema(name = "修改时间", example = "1", required = false, hidden = true)
    private LocalDateTime updateTime;
    @Column(unique = false, nullable = true, columnDefinition = "int(11) COMMENT '创建者id'")
    @Schema(name = "创建者id", example = "1", required = false, hidden = true)
    private Integer createBy;
    @Column(unique = false, nullable = true, columnDefinition = "int(11) COMMENT '修改者id'")
    @Schema(name = "修改者id", example = "1", required = false, hidden = true)
