...
public class SystemInfo {
     ...
     * @author 188****4787
     * @date 2021/04/28 17:58
     * 技术参考：<a href="https://blog.csdn.net/u012796085/article/details/104068769">...</a>
     */
     ...
     * @author 188****4787
     * @date 2021/04/28 17:58
     * 技术参考：<a href="https://blog.csdn.net/weixin_37738830/article/details/100108266">...</a>
     */
    private InetAddress getInetAddress () {
        InetAddress inetAddress = null;
        try {
            for (Enumeration<NetworkInterface> en = NetworkInterface.getNetworkInterfaces(); en.hasMoreElements(); ) {
                NetworkInterface vo = en.nextElement();
                String name = vo.getName();
                if (name.contains("docker") || name.contains("lo")) {
                    return inetAddress;
                }
                for (Enumeration<InetAddress> enumIpAddr = vo.getInetAddresses(); enumIpAddr.hasMoreElements(); ) {
