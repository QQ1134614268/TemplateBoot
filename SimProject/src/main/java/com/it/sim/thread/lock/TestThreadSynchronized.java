    ...
    static class Thread1 implements Runnable {
        ...
        public void run() {
            ...
            synchronized (TestThreadSynchronized.class) {
                log.info("enterThread1...");
                log.info("thread1is waiting");
                try {
                ...
                log.info("thread1is going on...");
                log.info("thread1is being over!");
            }
        }
    ...
    static class Thread2 implements Runnable {
        ...
        public void run() {
            synchronized (TestThreadSynchronized.class) {
                ...
                log.info("enterThread2...");

                log.info("thread2notify other thread can release wait status..");
                ...
                log.info("thread2is sleeping ten millisecond...");
                try {
                    Thread.sleep(10);
                } catch (InterruptedException e) {
                    e.printStackTrace();
