 ...
 */
public class TestInputStreamDownloadRead {
    public static void main(String[] args) throws IOException, InterruptedException {
        try (CloseableHttpClient httpclient = HttpClients.createDefault();
             CloseableHttpResponse pictureResponse = httpclient.execute(new HttpGet("http://172.16.6.128:9009/coastal/2023/01/17/t01291c13c2f9a092ca_20230117102521A021.jpg"));
             // 获取流
