...
public interface Device {
    ...
    public com.it.sim.webservice.onvif.client.NetworkZeroConfiguration getZeroConfiguration()
;
...
;
    ...
    public com.it.sim.webservice.onvif.client.NTPInformation getNTP()
;
    ...
    public void loadCertificateWithPrivateKey(
        ...
        java.util.List<com.it.sim.webservice.onvif.client.CertificateWithPrivateKey> certificateWithPrivateKey
    );
    ...
    public void setUser(
        ...
        java.util.List<com.it.sim.webservice.onvif.client.User> user
    );
    ...
    public com.it.sim.webservice.onvif.client.SystemDateTime getSystemDateAndTime()
;
    ...
    public void setNTP(
        ...
        java.util.List<com.it.sim.webservice.onvif.client.NetworkHost> ntpManual
    );
    ...
    public boolean setNetworkInterfaces(
        ...
        com.it.sim.webservice.onvif.client.NetworkInterfaceSetConfiguration networkInterface
    );
    ...
    public void setDPAddresses(
        ...
        java.util.List<com.it.sim.webservice.onvif.client.NetworkHost> dpAddress
    );
    ...
    public com.it.sim.webservice.onvif.client.SupportInformation getSystemSupportInformation()
;
    ...
    public void removeIPAddressFilter(
        ...
        com.it.sim.webservice.onvif.client.IPAddressFilter ipAddressFilter
    );
    ...
    public void setSystemDateAndTime(
        ...
        com.it.sim.webservice.onvif.client.SetDateTimeType dateTimeType,
        ...
        com.it.sim.webservice.onvif.client.TimeZone timeZone,
        @WebParam(name = "UTCDateTime", targetNamespace = "http://www.onvif.org/ver10/device/wsdl")
        com.it.sim.webservice.onvif.client.DateTime utcDateTime
    );
    ...
    public void createDot1XConfiguration(
        ...
        com.it.sim.webservice.onvif.client.Dot1XConfiguration dot1XConfiguration
    );
    ...
    public com.it.sim.webservice.onvif.client.DynamicDNSInformation getDynamicDNS()
;
    ...
    public void setDiscoveryMode(
        ...
        com.it.sim.webservice.onvif.client.DiscoveryMode discoveryMode
    );
    ...
    public com.it.sim.webservice.onvif.client.Certificate createCertificate(
    ...
    public java.util.List<com.it.sim.webservice.onvif.client.NetworkInterface> getNetworkInterfaces()
;
    ...
    public java.util.List<com.it.sim.webservice.onvif.client.Dot1XConfiguration> getDot1XConfigurations()
;
    ...
    public com.it.sim.webservice.onvif.client.IPAddressFilter getIPAddressFilter()
;
    ...
    public com.it.sim.webservice.onvif.client.RemoteUser getRemoteUser()
;
    ...
    public com.it.sim.webservice.onvif.client.DeviceServiceCapabilities getServiceCapabilities()
;
    ...
    public com.it.sim.webservice.onvif.client.DNSInformation getDNS()
;
    ...
    public void setRelayOutputState(
        ...
        com.it.sim.webservice.onvif.client.RelayLogicalState logicalState
    );
    ...
    public java.util.List<com.it.sim.webservice.onvif.client.LocationEntity> getGeoLocation()
;
    ...
    public void setDNS(
        ...
        java.util.List<com.it.sim.webservice.onvif.client.IPAddress> dnsManual
    );
...
;
    ...
    public com.it.sim.webservice.onvif.client.HostnameInformation getHostname()
;
    ...
    @WebResult(name = "Capabilities", targetNamespace = "http://www.onvif.org/ver10/device/wsdl")
    public com.it.sim.webservice.onvif.client.Capabilities getCapabilities(

        @WebParam(name = "Category", targetNamespace = "http://www.onvif.org/ver10/device/wsdl")
        java.util.List<com.it.sim.webservice.onvif.client.CapabilityCategory> category
    );
    ...
    public void setNetworkProtocols(
        ...
        java.util.List<com.it.sim.webservice.onvif.client.NetworkProtocol> networkProtocols
    );
    ...
    public com.it.sim.webservice.onvif.client.StorageConfiguration getStorageConfiguration(
    ...
    public void setGeoLocation(
        ...
        java.util.List<com.it.sim.webservice.onvif.client.LocationEntity> location
    );
    ...
    public java.util.List<com.it.sim.webservice.onvif.client.NetworkProtocol> getNetworkProtocols()
;
...
;
    ...
    public com.it.sim.webservice.onvif.client.Dot11Status getDot11Status(
    ...
    public java.util.List<com.it.sim.webservice.onvif.client.Service> getServices(
    ...
    public void setRemoteDiscoveryMode(
        ...
        com.it.sim.webservice.onvif.client.DiscoveryMode remoteDiscoveryMode
    );
    ...
    public com.it.sim.webservice.onvif.client.NetworkGateway getNetworkDefaultGateway()
;
    ...
    public com.it.sim.webservice.onvif.client.DiscoveryMode getDiscoveryMode()
;
    ...
    public com.it.sim.webservice.onvif.client.BinaryData getAccessPolicy()
;
    ...
    public void getSystemUris(
        ...
        javax.xml.ws.Holder<com.it.sim.webservice.onvif.client.GetSystemUrisResponse.Extension> extension
    );
    ...
    public void loadCertificates(
        ...
        java.util.List<com.it.sim.webservice.onvif.client.Certificate> nvtCertificate
    );
    ...
    @WebResult(name = "NvtCertificate", targetNamespace = "http://www.onvif.org/ver10/device/wsdl")
    public java.util.List<com.it.sim.webservice.onvif.client.Certificate> getCertificates()
;
    ...
    public java.util.List<com.it.sim.webservice.onvif.client.Scope> getScopes()
;
    ...
    public void setRemoteUser(
        ...
        com.it.sim.webservice.onvif.client.RemoteUser remoteUser
    );
    ...
    public void setStorageConfiguration(
        ...
        com.it.sim.webservice.onvif.client.StorageConfiguration storageConfiguration
    );
    ...
    public void setSystemFactoryDefault(
        ...
        com.it.sim.webservice.onvif.client.FactoryDefaultType factoryDefault
    );
    ...
    public java.lang.String upgradeSystemFirmware(
        ...
        com.it.sim.webservice.onvif.client.AttachmentData firmware
    );
    ...
    public void setRelayOutputSettings(
        ...
        com.it.sim.webservice.onvif.client.RelayOutputSettings properties
    );
    ...
    public java.util.List<com.it.sim.webservice.onvif.client.CertificateStatus> getCertificatesStatus()
;
    ...
    public com.it.sim.webservice.onvif.client.BinaryData getPkcs10Request(
        ...
        com.it.sim.webservice.onvif.client.BinaryData attributes
    );
    ...
    public java.util.List<com.it.sim.webservice.onvif.client.StorageConfiguration> getStorageConfigurations()
;
    ...
    public com.it.sim.webservice.onvif.client.SystemLog getSystemLog(

        @WebParam(name = "LogType", targetNamespace = "http://www.onvif.org/ver10/device/wsdl")
        com.it.sim.webservice.onvif.client.SystemLogType logType
    );
    ...
    public java.util.List<com.it.sim.webservice.onvif.client.NetworkHost> getDPAddresses()
;
    ...
    public void restoreSystem(
        ...
        java.util.List<com.it.sim.webservice.onvif.client.BackupFile> backupFiles
    );
    ...
    public com.it.sim.webservice.onvif.client.DiscoveryMode getRemoteDiscoveryMode()
;
    ...
    public com.it.sim.webservice.onvif.client.CertificateInformation getCertificateInformation(
    ...
    public java.util.List<com.it.sim.webservice.onvif.client.User> getUsers()
;
    ...
    public java.util.List<com.it.sim.webservice.onvif.client.RelayOutput> getRelayOutputs()
;
    ...
    public void loadCACertificates(
        ...
        java.util.List<com.it.sim.webservice.onvif.client.Certificate> caCertificate
    );
    ...
    @WebResult(name = "Dot1XConfiguration", targetNamespace = "http://www.onvif.org/ver10/device/wsdl")
    public com.it.sim.webservice.onvif.client.Dot1XConfiguration getDot1XConfiguration(
    ...
    public java.lang.String createStorageConfiguration(
        ...
        @WebParam(name = "StorageConfiguration", targetNamespace = "http://www.onvif.org/ver10/device/wsdl")
        com.it.sim.webservice.onvif.client.StorageConfigurationData storageConfiguration
    );
    ...
    public java.util.List<com.it.sim.webservice.onvif.client.Dot11AvailableNetworks> scanAvailableDot11Networks(
    ...
    public void setAccessPolicy(
        ...
        com.it.sim.webservice.onvif.client.BinaryData policyFile
    );
    ...
    public void setCertificatesStatus(
        ...
        java.util.List<com.it.sim.webservice.onvif.client.CertificateStatus> certificateStatus
    );
    ...
    public void setDynamicDNS(
        ...
        com.it.sim.webservice.onvif.client.DynamicDNSType type,
        @WebParam(name = "Name", targetNamespace = "http://www.onvif.org/ver10/device/wsdl")
        java.lang.String name,
    ...
    public java.util.List<com.it.sim.webservice.onvif.client.BackupFile> getSystemBackup()
;
    ...
    public java.util.List<com.it.sim.webservice.onvif.client.Certificate> getCACertificates()
;
}
