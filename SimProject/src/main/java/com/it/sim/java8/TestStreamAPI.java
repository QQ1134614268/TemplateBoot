...
/**
 * @author zero DateTime 2018年5月4日 下午2:27:54
 * @ :
 */
public class TestStreamAPI {
    public static void main(String[] args) {
        ...
        // 计算空字符串
        List<String> strings = Arrays.asList("abc", "", "bc", "efg", "cd", "", "jkl");
        ...
        // 删除空字符串，并使用逗号把它们合并起来
        String separator = ", ";
        String mergedString = getMergedStringUsingJava7(strings, separator);
