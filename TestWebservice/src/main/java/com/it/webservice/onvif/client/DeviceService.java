 ...
 * 2023-03-14T00:13:23.491+08:00
 * Generated source version: 3.5.4
 *
 */
@WebServiceClient(name = "DeviceService",
                  wsdlLocation = "file:/E:/workspace/JavaSpace/TemplateBoot/SimProject/src/main/java/com/it/sim/webservice/onvif/devicemgmt.wsdl",
...
public class DeviceService extends javax.xml.ws.Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/workspace/JavaSpace/TemplateBoot/SimProject/src/main/java/com/it/sim/webservice/onvif/devicemgmt.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(DeviceService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/E:/workspace/JavaSpace/TemplateBoot/SimProject/src/main/java/com/it/sim/webservice/onvif/devicemgmt.wsdl");
        }
        WSDL_LOCATION = url;
    }
