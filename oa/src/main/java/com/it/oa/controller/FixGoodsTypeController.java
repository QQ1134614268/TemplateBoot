...
@Api(tags = "行政管理/办公物资/物资管理/固定物资/分类")
@RestController
@RequestMapping("/api/enum/fixGoodsType")
@Slf4j
public class FixGoodsTypeController {
    private static final String group = FIX_GOODS_TYPE;
    @Resource
