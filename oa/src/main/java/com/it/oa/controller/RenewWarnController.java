...
import static com.it.oa.config.constant.MemoType.PayType.REPAY_WARN;

@Api(tags = "客户管理/合同管理/续费提醒")
@RestController
@RequestMapping("/api/renewWarn")
@Slf4j
public class RenewWarnController {
    public static final String type = MemoType.RENEWAL_REMINDER;
    public static final String payType = REPAY_WARN;
    @Resource
