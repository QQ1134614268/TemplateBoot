<template>
  <div class="dormitory">
    <div class="searchWord">
      ...
      <el-input v-model="search" style="display: inline-block;width: 30rem" placeholder="请输入搜索内容">
      </el-input>
    </div>
    // 遍历表格
    <div class="dormitoryData">
      <el-table ref="dormitoryTable" :data="tables" tooltip-effect="dark" stripe style="width: 100%">
